...
?>
<div class="panel panel-default event-menu-toolbar">批量操作：
    <?php
    $jsfuncton = false;
    $model = new zc\wechat\models\EventMenu();
...
<script type="text/javascript">
    ...
    function changeStatus(f, v, k) {
        ...
        var url = '<?= Yii::$app->urlManager->createUrl('event-menu/change-status-ajax') ?>';
        $.ajax({
            url: url,
