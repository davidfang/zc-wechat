...
/* @var $model zc\wechat\models\UserSearch */
/* @var $form yii\widgets\ActiveForm */
?>
<div class="panel panel-default user-toolbar">批量操作：
    <?php
    $jsfuncton = false;
    $model = new zc\wechat\models\User();
...
<script type="text/javascript">
    ...
    function changeStatus(f, v, k) {
        ...
        var url = '<?= Yii::$app->urlManager->createUrl('user/change-status-ajax') ?>';
        $.ajax({
            url: url,
