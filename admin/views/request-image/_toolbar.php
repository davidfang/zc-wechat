...
/* @var $model zc\wechat\models\RequestImageSearch */
/* @var $form yii\widgets\ActiveForm */
?>
<div class="panel panel-default request-image-toolbar">批量操作：
    <?php
    $jsfuncton = false;
    $model = new zc\wechat\models\RequestImage();
...
<script type="text/javascript">
    ...
    function changeStatus(f, v, k) {
        ...
        var url = '<?= Yii::$app->urlManager->createUrl('request-image/change-status-ajax') ?>';
        $.ajax({
            url: url,
