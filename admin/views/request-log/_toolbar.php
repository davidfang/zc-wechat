...
/* @var $model zc\wechat\models\RequestLogSearch */
/* @var $form yii\widgets\ActiveForm */
?>
<div class="panel panel-default request-log-toolbar">批量操作：
    <?php
    $jsfuncton = false;
    $model = new zc\wechat\models\RequestLog();
...
<script type="text/javascript">
    ...
    function changeStatus(f, v, k) {
        ...
        var url = '<?= Yii::$app->urlManager->createUrl('request-log/change-status-ajax') ?>';
        $.ajax({
            url: url,
