...
/* @var $searchModel zc\wechat\models\RequestVoiceSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Request Voices';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="request-voice-index">

    <p>
        <?= Html::a('添加 Request Voice', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
