...
?>
<div class="panel panel-default request-link-toolbar">批量操作：
    <?php
    $jsfuncton = false;
    $model = new zc\wechat\models\RequestLink();
...
<script type="text/javascript">
    ...
    function changeStatus(f, v, k) {
        ...
        var url = '<?= Yii::$app->urlManager->createUrl('request-link/change-status-ajax') ?>';
        $.ajax({
            url: url,
