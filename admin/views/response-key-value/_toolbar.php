...
/* @var $model zc\wechat\models\ResponseKeyValueSearch */
/* @var $form yii\widgets\ActiveForm */
?>
<div class="panel panel-default response-key-value-toolbar">批量操作：
    <?php
    $jsfuncton = false;
    $model = new zc\wechat\models\ResponseKeyValue();
...
<script type="text/javascript">
    ...
    function changeStatus(f, v, k) {
        ...
        var url = '<?= Yii::$app->urlManager->createUrl('response-key-value/change-status-ajax') ?>';
        $.ajax({
            url: url,
