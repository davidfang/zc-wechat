...
?>
<div class="panel panel-default event-scan-toolbar">批量操作：
    <?php
    $jsfuncton = false;
    $model = new zc\wechat\models\EventScan();
...
<script type="text/javascript">
    ...
    function changeStatus(f, v, k) {
        ...
        var url = '<?= Yii::$app->urlManager->createUrl('event-scan/change-status-ajax') ?>';
        $.ajax({
            url: url,
