...
?>
<div class="panel panel-default response-reply-toolbar">批量操作：
    <?php
    $jsfuncton = false;
    $model = new zc\wechat\models\ResponseReply();
...
<script type="text/javascript">
    ...
    function changeStatus(f, v, k) {
        ...
        var url = '<?= Yii::$app->urlManager->createUrl('response-reply/change-status-ajax') ?>';
        $.ajax({
            url: url,
