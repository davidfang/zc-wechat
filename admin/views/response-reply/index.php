...
/* @var $searchModel zc\wechat\models\ResponseReplySearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Response Replies';
...
?>
<div class="response-reply-index">

    <p>
        <?= Html::a('添加 Response Reply', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
...
[
            ...
            [
                ...
                'template' => '{type_text} {type_image} {type_video} {type_music} {type_voice} {type_news}  {view} {update}{delete} ',
            ]
        ],
    ]);
    ?>
