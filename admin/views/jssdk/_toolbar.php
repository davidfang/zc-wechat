...
/* @var $model zc\wechat\models\JssdkSearch */
/* @var $form yii\widgets\ActiveForm */
?>
<div class="panel panel-default jssdk-toolbar">批量操作：
    <?php
    $jsfuncton = false;
    $model = new zc\wechat\models\Jssdk();
...
<script type="text/javascript">
    ...
    function changeStatus(f, v, k) {
        ...
        var url = '<?= Yii::$app->urlManager->createUrl('jssdk/change-status-ajax') ?>';
        $.ajax({
            url: url,
