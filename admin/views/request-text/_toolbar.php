...
/* @var $model zc\wechat\models\RequestTextSearch */
/* @var $form yii\widgets\ActiveForm */
?>
<div class="panel panel-default request-text-toolbar">批量操作：
    <?php
    $jsfuncton = false;
    $model = new zc\wechat\models\RequestText();
...
<script type="text/javascript">
    ...
    function changeStatus(f, v, k) {
        ...
        var url = '<?= Yii::$app->urlManager->createUrl('request-text/change-status-ajax') ?>';
        $.ajax({
            url: url,
