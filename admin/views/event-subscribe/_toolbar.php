...
/* @var $model zc\wechat\models\EventSubscribeSearch */
/* @var $form yii\widgets\ActiveForm */
?>
<div class="panel panel-default event-subscribe-toolbar">批量操作：
    <?php
    $jsfuncton = false;
    $model = new zc\wechat\models\EventSubscribe();
...
<script type="text/javascript">
    ...
    function changeStatus(f, v, k) {
        ...
        var url = '<?= Yii::$app->urlManager->createUrl('event-subscribe/change-status-ajax') ?>';
        $.ajax({
            url: url,
