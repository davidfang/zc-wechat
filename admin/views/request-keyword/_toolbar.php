...
/* @var $model zc\wechat\models\RequestKeywordSearch */
/* @var $form yii\widgets\ActiveForm */
?>
<div class="panel panel-default request-keyword-toolbar">批量操作：
    <?php
    $jsfuncton = false;
    $model = new zc\wechat\models\RequestKeyword();
...
<script type="text/javascript">
    ...
    function changeStatus(f, v, k) {
        ...
        var url = '<?= Yii::$app->urlManager->createUrl('request-keyword/change-status-ajax') ?>';
        $.ajax({
            url: url,
