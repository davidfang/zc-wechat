...
?>
<div class="panel panel-default wechat-toolbar">批量操作：
    <?php
    $jsfuncton = false;
    $model = new zc\wechat\models\Wechat();
...
<script type="text/javascript">
    ...
    function changeStatus(f, v, k) {
        ...
        var url = '<?= Yii::$app->urlManager->createUrl('/wechat/wechat/change-status-ajax') ?>';
        $.ajax({
            url: url,
