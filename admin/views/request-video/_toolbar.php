...
?>
<div class="panel panel-default request-video-toolbar">批量操作：
    <?php
    $jsfuncton = false;
    $model = new zc\wechat\models\RequestVideo();
...
<script type="text/javascript">
    ...
    function changeStatus(f, v, k) {
        ...
        var url = '<?= Yii::$app->urlManager->createUrl('request-video/change-status-ajax') ?>';
        $.ajax({
            url: url,
