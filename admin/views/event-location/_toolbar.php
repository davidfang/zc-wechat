...
?>
<div class="panel panel-default event-location-toolbar">批量操作：
    <?php
    $jsfuncton = false;
    $model = new zc\wechat\models\EventLocation();
...
<script type="text/javascript">
    ...
    function changeStatus(f, v, k) {
        ...
        var url = '<?= Yii::$app->urlManager->createUrl('event-location/change-status-ajax') ?>';
        $.ajax({
            url: url,
