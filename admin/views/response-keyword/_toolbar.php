...
/* @var $model zc\wechat\models\ResponseKeywordSearch */
/* @var $form yii\widgets\ActiveForm */
?>
<div class="panel panel-default response-keyword-toolbar">批量操作：
    <?php
    $jsfuncton = false;
    $model = new zc\wechat\models\ResponseKeyword();
...
<script type="text/javascript">
    ...
    function changeStatus(f, v, k) {
        ...
        var url = '<?= Yii::$app->urlManager->createUrl('response-keyword/change-status-ajax') ?>';
        $.ajax({
            url: url,
