...
/* @var $model zc\wechat\models\ErrorLogSearch */
/* @var $form yii\widgets\ActiveForm */
?>
<div class="panel panel-default error-log-toolbar">批量操作：
    <?php
    $jsfuncton = false;
    $model = new zc\wechat\models\ErrorLog();
...
<script type="text/javascript">
    ...
    function changeStatus(f, v, k) {
        ...
        var url = '<?= Yii::$app->urlManager->createUrl('error-log/change-status-ajax') ?>';
        $.ajax({
            url: url,
