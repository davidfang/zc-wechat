...
use zc\wechat\models\EventSubscribeSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;
use yii\web\UploadedFile;
/**
 * EventSubscribeController 控制器对 EventSubscribe 模型 CRUD 操作.
 */
class EventSubscribeController extends Controller
{
    ...
    {
        $searchModel = new EventSubscribeSearch();
    ...
    /**
     * Creates a new EventSubscribe model.
    ...
    */
    ...
    /**
     * 根据primary key查找 EventSubscribe 模型的信息
     * 如果数据不存在跳转到 404
     * @param integer $id
     * @return EventSubscribe the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = EventSubscribe::findOne($id)) !== null) {
            return $model;
        } else {
