...
use zc\wechat\models\EventMenuSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;
use yii\web\UploadedFile;
/**
 * EventMenuController 控制器对 EventMenu 模型 CRUD 操作.
 */
class EventMenuController extends Controller
{
    ...
    {
        $searchModel = new EventMenuSearch();
    ...
    */
    ...
    /**
     * 根据primary key查找 EventMenu 模型的信息
     * 如果数据不存在跳转到 404
     * @param integer $id
     * @return EventMenu the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = EventMenu::findOne($id)) !== null) {
            return $model;
        } else {
