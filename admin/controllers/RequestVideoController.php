...
use zc\wechat\models\RequestVideoSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;
use yii\web\UploadedFile;
/**
 * RequestVideoController 控制器对 RequestVideo 模型 CRUD 操作.
 */
class RequestVideoController extends Controller
{
    ...
    {
        $searchModel = new RequestVideoSearch();
    ...
    /**
     * Creates a new RequestVideo model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new RequestVideo();
    ...
    */
    ...
    /**
     * 根据primary key查找 RequestVideo 模型的信息
     * 如果数据不存在跳转到 404
     * @param string $id
     * @return RequestVideo the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = RequestVideo::findOne($id)) !== null) {
            return $model;
        } else {
