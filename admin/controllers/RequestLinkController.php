...
use zc\wechat\models\RequestLinkSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;
use yii\web\UploadedFile;
/**
 * RequestLinkController 控制器对 RequestLink 模型 CRUD 操作.
 */
class RequestLinkController extends Controller
{
    ...
    {
        $searchModel = new RequestLinkSearch();
    ...
    /**
     * Creates a new RequestLink model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new RequestLink();
    ...
    */
    ...
    /**
     * 根据primary key查找 RequestLink 模型的信息
     * 如果数据不存在跳转到 404
     * @param string $id
     * @return RequestLink the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = RequestLink::findOne($id)) !== null) {
            return $model;
        } else {
