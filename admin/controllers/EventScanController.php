...
use zc\wechat\models\EventScanSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;
use yii\web\UploadedFile;
/**
 * EventScanController 控制器对 EventScan 模型 CRUD 操作.
 */
class EventScanController extends Controller
{
    ...
    {
        $searchModel = new EventScanSearch();
    ...
    */
    ...
    /**
     * 根据primary key查找 EventScan 模型的信息
     * 如果数据不存在跳转到 404
     * @param integer $id
     * @return EventScan the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = EventScan::findOne($id)) !== null) {
            return $model;
        } else {
