...
use zc\wechat\models\RequestImageSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;
use yii\web\UploadedFile;
/**
 * RequestImageController 控制器对 RequestImage 模型 CRUD 操作.
 */
class RequestImageController extends Controller
{
    ...
    {
        $searchModel = new RequestImageSearch();
    ...
    /**
     * Creates a new RequestImage model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new RequestImage();
    ...
    */
    ...
    /**
     * 根据primary key查找 RequestImage 模型的信息
     * 如果数据不存在跳转到 404
     * @param string $id
     * @return RequestImage the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = RequestImage::findOne($id)) !== null) {
            return $model;
        } else {
